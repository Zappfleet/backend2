        ...
        for (const oldAccountData of oldAccountsData) {
            try {
                ...
                oldAccountData?.role?.map(role => {
                    switch (role) {
                        case 0: //passenger
                            createNewRole.push(ObjectId('663902a12733b1e14bcde2f4'))
                            break;
                        ...
                        case 2: //manager
                            createNewRole.push(ObjectId('663f11c3185aeaa232719f76'))
                            break;

                        case 3://dispatcher
                            createNewRole.push(ObjectId('663f7ec2665933a1316d2697'))
                            break;

                        case 4: //superDispatcher
                            createNewRole.push(ObjectId('664a047476905c9e69a259d0'))
                            break;

                        case 5://admin
                            createNewRole.push(ObjectId('663902a12733b1e14bcde2f2'))
                            break;

                        case 6://operator
                            createNewRole.push(ObjectId('66605998eafc2a3a887c0dc4'))
                            break;
                    }
                ...
                console.error(`Error migrating request ID ${oldAccountData._id}:`, error.message);
                res.status(500).json({
                    status: "5000",
